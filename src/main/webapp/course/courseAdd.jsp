			  ...
			  <div class="panel-body">
				<form role="form">
				  ...
				  <div class="form-group">
					...
					<input type="text" id="coursetype" name="coursetype" class="form-control"  placeholder="请输入课程类型">
				  </div>
				  <div class="form-group">
					<label for="exampleInputEmail1">课程学分</label>
					<input type="email" id="coursescore" name="coursescore" class="form-control" placeholder="请输入课程分数">
				  </div>
				  <button type="button" id="btnCourseAdd" class="btn btn-success"><i class="glyphicon glyphicon-plus"></i>确定新增</button>
        ...
        <script type="text/javascript">
            $(function () {
				...
				$("#btnCourseAdd").click(function() {
					$.ajax({
						url:"${ItemPath}/course/courseAdd",
						type:"post",
						data:{"coursename":$("#coursename").val(),"coursetype":$("#coursetype").val(),"coursescore":$("#coursescore").val()},
						success:function(result){
							
							window.location.href = "${ItemPath}/course/courseList";
						}
					});
				});
            });
