			  ...
			  <div class="panel-body">
				<form role="form">
				  <div class="form-group">
					...
					<input type="text" class="form-control" id="uaccount" value="${user.uaccount }">
				  </div>
				  <div class="form-group">
				  ...
				  <div class="form-group">
					...
					<input type="email" class="form-control" id="uemail" value="${user.uemail }">
        ...
        <script type="text/javascript">
            $(function () {
			    ...
			    $("#btnUpdate").click(function(){
			         ...
			         if(uaccountVal==""){
			        	 layer.msg("账号不能为空!", {time:1000, icon:0, shift:5}, function(){});
			             return;
			         }
