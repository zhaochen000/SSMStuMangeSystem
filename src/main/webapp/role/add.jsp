			  ...
			  <div class="panel-body">
				<form role="form" id="saveForm">
				  <div class="form-group">
					<label for="exampleInputPassword1">用户角色名称</label>
					<input type="text" class="form-control" id="rname" name="rname" placeholder="请输入用户角色名称">
				  </div>
        ...
        <script type="text/javascript">
            $(function () {
			    ...
			    $("#btnSave").click(function(){
			         ...
			         if(rnameVal==""){
			        	 layer.msg("用户角色名称不能为空!", {time:1000, icon:0, shift:5}, function(){});
			        	 return;
			         }
			         
			    	$.ajax({
			    		url:"${ItemPath}/role/addRole",
			    		type:"post",
