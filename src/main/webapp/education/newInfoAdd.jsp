			  ...
			  <div class="panel-body">
				<form role="form" id="saveForm">
				  <div class="form-group">
					...
					<input type="text" class="form-control" id="infoName" name="infoName" placeholder="请输入公告名称">
				  </div>
				  <div class="form-group">
					<label for="exampleInputPassword1">发布单位</label>
					<input type="text" class="form-control" id="infoAdd" name="infoAdd" placeholder="请输入发布单位">
				  </div>	
				  <div class="form-group">
					<label for="exampleInputPassword1">发布日期</label>
					<input type="date" class="form-control" id="publishDate" name="publishDate" placeholder="请输入发布单位">
				  </div> 
				   <div class="form-group">
					<label for="exampleInputPassword1">公告内容</label>
					<input type="text" class="form-control" id="infoContent" name="infoContent" placeholder="请输入公告内容">
				  </div>
        ...
        <script type="text/javascript">
            $(function () {
			    ...
			    $("#btnSave").click(function(){
			         ...
			         if(publishDateVal==""){
			        	 layer.msg("发布日期!", {time:1000, icon:0, shift:5}, function(){});
			        	 return;
			         } 
			    	...
			    	$.ajax({
			    		url:"${ItemPath}/education/add",
			    		type:"post",
			    		data:{"infoName":$("#infoName").val(),"infoAdd":$("#infoAdd").val(),"publishDate":$("#publishDate").val(),"infoContent":$("#infoContent").val()},
